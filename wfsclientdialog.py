    ...
    def getFeature(self):
        ...
        if self.querytype == "storedquery":
            ...
            if len(self.bbox) < 1:
                ...
                self.logMessage(self.onlineresource + '?service=WFS&request=GetFeature&count=1&version=2.0.0&typenames=' + typeNames)
                ...
                query_string = "?service=WFS&request=GetFeature&version=2.0.0&srsName="+ self.ui.txtSrs.text().strip()+ "&typeNames="+typeNames+"&filter=" + filterString
